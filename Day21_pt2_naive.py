...
# Naive solution to part 2. Can do 1 code 20 robts in about 6 hours :(
...
def code_pos_to_my_dpad(code):
    ...
    for n in range(15):
        ...
        print(n, len(prev_dir_pos))

        next_seq = dir_pos_to_dir_seq(prev_dir_pos)
        next_pos = dir_seq_to_num_pos(next_seq)

        prev_dir_pos = next_pos


    s = dir_pos_to_string(next_pos)
